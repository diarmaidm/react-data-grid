	...
	var Canvas = React.createClass({
	  ...
	  render: function render() {
	    ...
	    if (this.state.rows.length > 0) {
	      var firstRowPosition = _.first(this.state.rows).position;
	      var lastRowPosition = _.min([_.last(this.state.rows).position, length]);
	    ...
	    var populatedRows = this.state.rows.reduce(function (visibleRows, _ref, idx) {
	      var position = _ref.position;
	      var row = _ref.row;

	      if (position < displayStart || position > displayEnd) return visibleRows;

	      visibleRows.push(_this.renderRow({
	        key: position,
	        ref: idx,
	        idx: position,
	        row: row,
	        ...
	        isSelected: _this.isRowSelected(position),
	  ...
	  renderLoadingRow: function renderLoadingRow(position, rowHeight) {
	    ...
	    return React.createElement('div', { style: { height: rowHeight }, key: position });
	  },

	  renderLoadingRows: function renderLoadingRows(startPosition, basePosition, rowHeight) {
	    var _this2 = this;

	    var count = startPosition - basePosition;
	    return _.map(_.range(0, count), function (idx) {
	      return _this2.renderLoadingRow(basePosition + idx, rowHeight);
	    });
	  },
	  ...
	  debounceRowRequest: function debounceRowRequest() {
	    var _this3 = this;

	    if (this.rowUpdateTimer) clearTimeout(this.rowUpdateTimer);

	    this.rowUpdateTimer = setTimeout(function () {
	      if (!_this3.isMounted()) return;
	      var newRows = _this3.getRows(_this3.state.displayStart, _this3.state.displayEnd);

	      var hasListSizeChanged = newRows.length !== _this3.state.rows.length;
	      var isDifferent = _.some(newRows, function (_ref2, index) {
	        var row = _ref2.row;
	        var position = _ref2.position;

	        var stateRow = _this3.state.rows[index];
	      ...
	      _this3.setState({ rows: newRows, shouldUpdate: true });
	  ...
	  getRows: function getRows(displayStart, displayEnd) {
	    ...
	    if (Array.isArray(this.props.rowGetter)) {
	      return this.props.rowGetter.slice(displayStart, displayEnd).map(function (row, idx) {
	        return { row: row, position: displayStart + idx };
	      });
	    } else {
	      var rows = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inherits = __webpack_require__(63)['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(62)('getOwnPropertyDescriptor', function($getOwnPropertyDescriptor){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$setPrototypeOf = __webpack_require__(66)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  updateScroll: function updateScroll(scrollTop, scrollLeft, height, rowHeight, length) {
	    ...
	    var displayStart = min(max(0, visibleStart - renderedRowsCount * 2), length);
